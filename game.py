...
stones = sprite.Group()
for i in range(1, 6):
   stone = Stone(img_stone, randint(80, win_width - 80), -40, 80, 50, randint(1, 3))
   stones.add(stone)
 ...
 #сама игра: действия спрайтов, проверка правил игры, перерисовка
   if not finish:
       ...
       for c in collides:
           ...
           score = score + 1
       collides = sprite.groupcollide(stones, bullets, True, True)
       for c in collides:
           monster = Enemy(img_enemy, randint(80, win_width - 80), -40, 80, 50, randint(1, 5))
           monsters.add(monster)
       for c in collides:
       ...
       if sprite.spritecollide(ship, stones, False) or lost >= max_lost:
           finish = True
